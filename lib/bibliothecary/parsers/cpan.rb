  ...
  module Parsers
    class CPAN
      ...
      def self.parse_json_manifest(file_contents, options: {})
        ...
        ParserResult.new(dependencies: dependencies, project_name: manifest["name"], git_info: HostedGitInfo.new(extract_repo_url(manifest)).to_h)
      end
      ...
      def self.extract_repo_url(manifest)
