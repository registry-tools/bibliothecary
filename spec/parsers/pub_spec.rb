...
describe Bibliothecary::Parsers::Pub do
  ...
  it "parses dependencies from pubspec.yaml" do
    expect(described_class.analyse_contents("pubspec.yaml", load_fixture("pubspec.yaml"))).to eq({
        ...
        Bibliothecary::Dependency.new(platform: "pub", name: "benchmark_harness", requirement: ">=1.0.0 <2.0.0", type: "development", source: "pubspec.yaml"),
        Bibliothecary::Dependency.new(platform: "pub", name: "guinness", requirement: ">=0.1.9 <0.2.0", type: "development", source: "pubspec.yaml"),
      ],
                                                                                                   kind: "manifest",
                                                                                                   success: true,
  ...
  it "parses dependencies from pubspec.lock" do
    expect(described_class.analyse_contents("pubspec.lock", load_fixture("pubspec.lock"))).to eq({
        ...
        Bibliothecary::Dependency.new(platform: "pub", name: "barback", requirement: "0.15.2+7", type: "runtime", source: "pubspec.lock"),
        Bibliothecary::Dependency.new(platform: "pub", name: "which", requirement: "0.1.3", type: "runtime", source: "pubspec.lock"),
      ],
                                                                                                   kind: "lockfile",
                                                                                                   success: true,
                                                                                                   repository_url: nil,
